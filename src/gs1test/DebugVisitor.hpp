#ifndef GS1PARSE_DEBUG_VISITOR_HPP
#define GS1PARSE_DEBUG_VISITOR_HPP
...
namespace gs1
{
class DebugVisitor : public SyntaxTreeVisitor
{
public:
  DebugVisitor(ISource &source, bool printTerminals = false);
...
private:
  void PrintNode(SyntaxNode *node, const char *name);
